...
function CaravanInfoPurchase() {
  ...
  return (
    <PurchaseContainer>
        ...
        <PurchaseCarWrapper>
            <PurchaseLeftWrapper>
                <PurchaseLeftWrapperImg src={data.caravan.image} alt="" />
                <PurchaseLeftWrapperPriceBox>
                    <p>Purchase price</p>
                    <p style={{fontWeight: "600"}}>{data.caravan.price}</p>
                </PurchaseLeftWrapperPriceBox>
            </PurchaseLeftWrapper>

            <PurchaseRightWrapper>
                <SpaceBetween>
                    <h1 style={{fontWeight: '600'}}>{data.caravan.name}</h1>
                    <h1 style={{fontWeight: '600', color: "#006DAB", marginTop: '20px'}}>{data.caravan.price} W</h1>
                </SpaceBetween>
...
export default CaravanInfoPurchase
