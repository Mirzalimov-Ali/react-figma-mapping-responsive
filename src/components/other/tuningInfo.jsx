...
function TuningInfo() {
  ...
  const { id } = useParams();
  const resultData = tuning.maindata.find((value) => value.id === parseInt(id));
    ...
    <CarInfoContainer>
      ...
      <LineWrappers>
        ...
        <InfoWrapper>
            <InfoWrapperLine1>
                <div>
                    <h3>{resultData.tuning.name}</h3>
                    <small>aid</small>
                </div>
                <p style={{fontSize: "30px", fontWeight: "600", color: "#006DAB"}}>{resultData.tuning.price}Won</p>
            </InfoWrapperLine1>
            <InfoWrapperLine/>
            <InfoWrapperLine2>
                <InfoWrapperBottom>
                    <p>Company</p>
                    <p style={{fontSize: "12px", opacity: "0.5"}}>{resultData.tuning.company}</p>
                </InfoWrapperBottom>
                <InfoWrapperBottom>
                    <p>People</p>
                    <p style={{fontSize: "12px", opacity: "0.5"}}>{resultData.tuning.people}</p>
                </InfoWrapperBottom>
                <InfoWrapperBottom>
                    <p>License type</p>
